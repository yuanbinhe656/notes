# [类的生命周期](https://duhouan.github.io/Java/#/JVM/6_类加载机制?id=类的生命周期)
...
## [自定义类加载器实现](https://duhouan.github.io/Java/#/JVM/6_类加载机制?id=自定义类加载器实现)
...
# [Java程序入口：main()方法讲解](https://www.cnblogs.com/bingyimeiling/p/10409728.html)

# [磁盘操作](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=磁盘操作)

我们要想实现IO的操作，就必须知道硬盘上文件的表现形式。而Java就提供了一个类File供我们使用。

## [File对象](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=file对象)
...
File(File parent, String child) //根据一个父File对象和一个子文件/目录得到File对象Copy to clipboardErrorCopied
...
## [创建功能](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=创建功能)

```java
public boolean createNewFile() //创建文件 如果存在这样的文件，就不创建了
public boolean mkdir()  //创建文件夹 如果存在这样的文件夹，就不创建了
public boolean mkdirs() //创建文件夹,如果父文件夹不存在，会帮你创建出来Copy to clipboardErrorCopied
...
## [删除功能](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=删除功能)

```java
public boolean delete()Copy to clipboardErrorCopied
```
...
## [重命名功能](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=重命名功能)

```java
public boolean renameTo(File dest)
//如果路径名相同，就是改名。
//如果路径名不同，就是改名并剪切。Copy to clipboardErrorCopied
...
## [判断功能](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=判断功能)
...
public boolean isHidden() //判断是否隐藏Copy to clipboardErrorCopied
...
## [获取功能I](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=获取功能i)
...
public long lastModified() //获取最后一次的修改时间，毫秒值Copy to clipboardErrorCopied
...
## [获取功能II](https://duhouan.github.io/Java/#/JavaIO/2_磁盘操作?id=获取功能ii)

```java
public String[] list() //获取指定目录下的所有文件或者文件夹的名称数组
public File[] listFiles() //获取指定目录下的所有文件或者文件夹的File数组Copy to clipboardErrorCopied
